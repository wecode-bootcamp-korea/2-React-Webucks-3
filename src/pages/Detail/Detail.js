        ...
        <div className="detailContainer">
              ...
              <article className="productMainContents">
                <div className="productDetailHeadWrap">
                  <div className="productDetailHeadWrap">
                    ...
                    <i className="far fa-heart" id="likeBtn"></i>
                  </div>
                ...
                <div className="reviewWrap">
                  <div className="reviewBox">
                    <div className="reviewDetailWrap">
                      ...
                      <i className="far fa-thumbs-up" id="likeReview1"></i>
                    ...
                    <div className="reviewDetailWrap">
                      ...
                      <i className="far fa-thumbs-up" id="likeReview2"></i>
                      <i className="fas fa-trash-alt"></i>
                    </div>
                    <div className="reviewDetailWrap">
                      ...
                      <i className="far fa-thumbs-up" id="likeReview3"></i>
                      <i className="fas fa-trash-alt"></i>
                    </div>
                  </div>
          ...
          <footer className="detailFooter">
            <ul className="categoryWrap">
              <li>
                <a href="javascript:void(0)" className="categoryHead">
                  COMPANY
                </a>
              </li>
              <li>
